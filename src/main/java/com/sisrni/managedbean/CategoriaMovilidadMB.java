...
public class CategoriaMovilidadMB{
    ...
    /** 
     * Metodo que crea instancias de 'CategoriaMovilidad' y 'Organismo' y almacena
    ...
    /**
     * Metodo que se ocupa de precargar la instancia de 'CategoriaMovilidad' a ser actualizada
    ...
    /**
     * Metodo para actualizar las propiedades de la instancia de 'CategoriaMovilidad'
     * seleccionada
     */
