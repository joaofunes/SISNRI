 ...
 * @author Cortez
 */
@Named("mapaInteractivoMovilidad")
@Scope(WebApplicationContext.SCOPE_APPLICATION)
public class MapaInteractivoMovilidad implements Serializable {

    private static final long serialVersionUID = 1L;
    private final static Log log = LogFactory.getLog(MapaInteractivoMovilidad.class);
...
//    ProyectoService proyectoService;
    public MapaInteractivoMovilidad() {
    }
