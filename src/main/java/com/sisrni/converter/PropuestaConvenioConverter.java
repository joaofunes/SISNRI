 ...
 * @author Joao
 */
@Component(value = "propuestaConvenioConverter")
public class PropuestaConvenioConverter implements Converter{
   ...
   @Override
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof PropuestaConvenio) {
            PropuestaConvenio o = (PropuestaConvenio) object;
            return getStringKey(o.getIdPropuesta());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), PropuestaConvenio.class.getName()});
            return null;
        }
    }
