 ...
 * @author HDEZ
 */
public class ResumenHistorialReparacionTecnicoNoSubContratadoLazyModel extends GenericLazyModel<Equipo, Integer> {

    public ResumenHistorialReparacionTecnicoNoSubContratadoLazyModel(GenericService<Equipo, Integer> service) {
        super(service);
    }
   @Override
